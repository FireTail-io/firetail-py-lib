...
DEFINITIONS = {
    "new_stack": {
        ...
        "type": "object",
        "properties": {
            "keep_stacks": {"type": "integer", "description": "Number of older stacks to keep"},
            "image_version": {"type": "string", "description": "Docker image version to deploy"},
            "senza_yaml": {"type": "string", "description": "YAML to provide to senza"},
            "new_traffic": {"type": "integer", "description": "Percentage of the traffic"},
        },
    },
    "composed": {
        "required": ["test"],
...
OPERATION1 = {
    ...
    "parameters": [
        {"in": "body", "name": "new_stack", "required": True, "schema": {"$ref": "#/definitions/new_stack"}}
    ],
    "responses": {
        201: {
...
OPERATION5 = {
    ...
    "information needed to keep track of deployment",
    "operationId": "fakeapi.hello.post_greeting",
    "parameters": [{"in": "body", "name": "new_stack", "required": True, "type": "integer", "default": "stack"}],
    "responses": {
        "201": {
            "description": "Stack to be created. The "
            "CloudFormation Stack creation can "
    ...
    "parameters": [
        {
            ...
            "in": "body",
            "name": "new_stack",
            "default": {"keep_stack": 1, "image_version": 1, "senza_yaml": "senza.yaml", "new_traffic": 100},
            "schema": {"$ref": "#/definitions/new_stack"},
        }
    ],
    "responses": {},
...
OPERATION8 = {
    ...
    "information needed to keep track of deployment",
    "operationId": "fakeapi.hello.post_greeting",
    "parameters": [{"in": "body", "name": "test", "required": True, "schema": {"$ref": "#/definitions/composed"}}],
    "responses": {
        "201": {
            "description": "Stack to be created. The "
            "CloudFormation Stack creation can "
...
SECURITY_DEFINITIONS_2_KEYS = {
    "key1": {"type": "apiKey", "in": "header", "name": "X-Auth-1", "x-apikeyInfoFunc": "math.ceil"},
    "key2": {"type": "apiKey", "in": "header", "name": "X-Auth-2", "x-apikeyInfoFunc": "math.ceil"},
}
