import pytest
from firetail.middleware import FiretailMiddleware
...
class TestMiddleware:
    ...
    async def __call__(self, scope, receive, send):
        operation_id = scope["extensions"]["firetail_routing"]["operation_id"]
...
def middleware_app(request):
    middlewares = FiretailMiddleware.default_middlewares + [TestMiddleware]
