...
def test_errors(problem_app):
    ...
    assert (
        error500["detail"] == "The server encountered an internal error and was unable to complete your request. "
    ...
    problematic_json = app_client.get("/v1.0/json_response_with_undefined_value_to_serialize")  # type: flask.Response
