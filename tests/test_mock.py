...
def test_mock_resolver_example():
    ...
    responses = {
        "default": {"schema": {"type": "object", "properties": {"foo": {"type": "string"}}, "example": {"foo": "bar"}}}
    }
...
def test_mock_resolver_example_nested_in_object_openapi():
    ...
    responses = {
        "default": {
            "content": {
                "application/json": {
                    "schema": {"type": "object", "properties": {"foo": {"type": "string", "example": "bar"}}}
                }
            }
        }
    }
...
def test_mock_resolver_example_nested_in_list_openapi():
    ...
    responses = {
        "default": {
            "content": {
                "application/json": {"schema": {"type": "array", "items": {"type": "string", "example": "bar"}}}
            }
        }
    }
...
def test_mock_resolver_notimplemented():
    ...
    operation = Swagger2Operation(
        ...
        path="endpoint",
        path_parameters=[],
        operation={"operationId": "fakeapi.hello.nonexistent_function", "responses": responses},
        app_produces=["application/json"],
        app_consumes=["application/json"],
        app_security=[],
        security_definitions={},
